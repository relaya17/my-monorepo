...
import safeZoneRoutes from './safeZoneRoutes.js';
import digitalKeyRoutes from './digitalKeyRoutes.js';
...
router.use('/safe-zone', safeZoneRoutes);
router.use('/digital-key', digitalKeyRoutes);

...
const CookieBanner: React.FC = () => {
  ...
  const saveAndHide = (value: Exclude<CookieConsent, null>) => {
  ...
  const expandedValue = preferencesOpen ? 'true' : 'false';

  return (
    <div
      className="cookie-banner position-fixed bottom-0 start-0 end-0 p-3 shadow-lg cookie-banner--dark"
      role="dialog"

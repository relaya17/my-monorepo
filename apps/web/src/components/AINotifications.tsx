    ...
    <div className="ai-notifications-container">
      ...
      {showNotifications && (
        <div className="position-absolute top-100 end-0 mt-2 z-1000">
          <div className="card shadow-lg ai-notifications-card">
            ...
            <div className="card-body p-0 ai-notifications-body">
              {loading ? (
      ...
      {(showNotifications || showAlerts) && (
        <div
          className="position-fixed top-0 start-0 w-100 h-100 ai-notifications-backdrop"
          onClick={() => {

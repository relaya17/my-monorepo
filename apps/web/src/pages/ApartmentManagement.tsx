...
const ApartmentManagement: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="apartment-page-offset">
        <NavigationBar />
  ...
  return (
    <div className="apartment-page-offset">
      ...
      <Container fluid className="mt-4">
        <Row>
          <Col>
            <h2 className="mb-4 text-center apartment-page-title">
                            ...
                            <div className="d-flex">
                              {apartment.images.slice(0, 2).map((image, index) => (
                                <Image
                                  ...
                                  width={40}
                                  height={40}
                                  className="rounded me-1 apartment-thumbnail"
                                />
                              ))}
                              {apartment.images.length > 2 && (
                                <div className="d-flex align-items-center justify-content-center bg-light rounded ms-1 apartment-thumbnail-counter">
                                  <small className="text-muted">+{apartment.images.length - 2}</small>
                                </div>
                              )}
                            </div>
                          ) : (
                            <div className="d-flex align-items-center justify-content-center bg-light rounded apartment-thumbnail-placeholder">
            ...
            <Form.Group className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="apartment-hidden-file-input"
                  aria-label="העלאת תמונות דירה"
                  title="העלאת תמונות דירה"
                />
              </div>

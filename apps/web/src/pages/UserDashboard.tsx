...
const UserDashboard: React.FC = () => {
  ...
  return (
    <div className="container-fluid p-4 user-dashboard">
      {/* <NavigationBar /> הוסר */}
      <div className="row">
        <div className="col-12 d-flex justify-content-between align-items-center mb-5">
          <div></div>
                      <h1 className="text-center user-dashboard-title">
      ...
      <div className="row g-4">
        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm border-0 user-dashboard-card">
            <div className="card-body text-center">
              <div className="mb-3">
                <i className="fas fa-credit-card fa-3x user-dashboard-icon-green"></i>
              </div>
                              <h5 className="card-title user-dashboard-card-title">תשלומים</h5>
        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm border-0 user-dashboard-card">
            <div className="card-body text-center">
              <div className="mb-3">
                <i className="fas fa-tools fa-3x user-dashboard-icon-purple"></i>
              </div>
                              <h5 className="card-title user-dashboard-card-title">בקשות תחזוקה</h5>
        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm border-0 user-dashboard-card">
            <div className="card-body text-center">
              <div className="mb-3">
                <i className="fas fa-seedling fa-3x user-dashboard-icon-green"></i>
              </div>
                              <h5 className="card-title user-dashboard-card-title">גינון</h5>
        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm border-0 user-dashboard-card">
            <div className="card-body text-center">
              <div className="mb-3">
                <i className="fas fa-key fa-3x user-dashboard-icon-amber"></i>
              </div>
                              <h5 className="card-title user-dashboard-card-title">דירות להשכרה</h5>
        ...
        <div className="col-md-6 col-lg-4">
          <div className="card h-100 shadow-sm border-0 user-dashboard-card">
            <div className="card-body text-center">
              <div className="mb-3">
                <i className="fas fa-home fa-3x user-dashboard-icon-red"></i>
              </div>
                              <h5 className="card-title user-dashboard-card-title">דירות למכירה</h5>
      ...
      <div className="row mt-4">
        <div className="col-12">
                      <h3 className="text-center mb-4 user-dashboard-stats-title">סטטיסטיקות אישיות</h3>
        </div>
        ...
        <div className="col-md-3">
          <div className="card text-center border-0 shadow-sm">
            <div className="card-body">
              <h4 className="user-dashboard-stat-grey">3</h4>
        ...
        <div className="col-md-3">
          <div className="card text-center border-0 shadow-sm">
            <div className="card-body">
              <h4 className="user-dashboard-stat-amber">2</h4>
        ...
        <div className="col-md-3">
          <div className="card text-center border-0 shadow-sm">
            <div className="card-body">
              <h4 className="user-dashboard-stat-grey">12</h4>

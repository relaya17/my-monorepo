    ...
    <div className="forrent-container">
      ...
      <div className="cards-grid">
        {apartments.map((apartment) => {
          ...
          return (
            <div
              className={`apartment-card apartment-card-stretch${hoveredId === apartment.id ? ' flipped' : ''}`}
              key={apartment.id}
              onMouseEnter={() => setHoveredId(apartment.id)}
              onMouseLeave={() => setHoveredId(null)}
            >
              <div className="apartment-card-flex">
                <div className="apartment-card-inner">
                  <div className="apartment-card-front">
                    <div className="card-overlay"></div>
                    <div className="apartment-card-front-content">

...
const ReceiptPage: React.FC = () => {
  ...
  if (!paymentInfo) {
    return (
      <div className="container-fluid d-flex justify-content-center align-items-center receipt-page-loading">
        <div className="card shadow-lg receipt-page-card-sm">
          <div className="card-body p-5 text-center">
            <i className="fas fa-exclamation-triangle fa-3x mb-3 receipt-page-warning-icon"></i>
  ...
  return (
    <div className="container-fluid d-flex justify-content-center align-items-center receipt-page-container">
      <div className="card shadow-lg receipt-page-card-lg">
        <div className="card-body p-5 receipt-page-card-body">
          <div className="text-center mb-4">
            <i className="fas fa-receipt fa-3x text-success mb-3"></i>
            <h2 className="card-title receipt-page-title">
              קבלה לתשלום
            </h2>

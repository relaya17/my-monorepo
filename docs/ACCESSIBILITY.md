# מדריך נגישות - מצפה נוף (HSLL Enterprise)

מדריך זה מתאר את תכונות הנגישות הזמינות במערכת ניהול הדיירים "מצפה נוף". לפי מפרט HSLL Enterprise: **Mobile-First**, **ARIA על כל כפתור**, **ניגודיות גבוהה לדיירים מבוגרים**, ותאימות WCAG.
